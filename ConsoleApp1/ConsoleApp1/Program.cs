...
namespace MSCDA5510
{
    class ContactGenerator
    {
        ...
        public ContactGenerator()
        {
            ...
            String outputFileName = @"C:\Users\Mani Santhamohan\Documents\GitHub\A00429112_MCDA5510\ConsoleApp1\ConsoleApp1\customers.csv";
        ...
        {
            String firstNames = @"C:\Users\Mani Santhamohan\Documents\GitHub\A00429112_MCDA5510\ConsoleApp1\ConsoleApp1\firstNames.txt";
            return ReturnRandomLine(firstNames);
        }

        public string GenerateLastName()
        {
            String lastNames = @"C:\Users\Mani Santhamohan\Documents\GitHub\A00429112_MCDA5510\ConsoleApp1\ConsoleApp1\lastNames.txt";
            return ReturnRandomLine(lastNames);
        }

        public string GenerateStreetNumber()
        {
            String streetNum = @"C:\Users\Mani Santhamohan\Documents\GitHub\A00429112_MCDA5510\ConsoleApp1\ConsoleApp1\streetNum.txt";
            return ReturnRandomLine(streetNum);
        }

        public string GenerateStreet()
        {
            String street = @"C:\Users\Mani Santhamohan\Documents\GitHub\A00429112_MCDA5510\ConsoleApp1\ConsoleApp1\street.txt";
            return ReturnRandomLine(street);
        }

        public string GenerateCity()
        {
            String cityName = @"C:\Users\Mani Santhamohan\Documents\GitHub\A00429112_MCDA5510\ConsoleApp1\ConsoleApp1\city.txt";
            return ReturnRandomLine(cityName);
        }

        public string GenerateProvince()
        {
            String provinceName = @"C:\Users\Mani Santhamohan\Documents\GitHub\A00429112_MCDA5510\ConsoleApp1\ConsoleApp1\province.txt";
            return ReturnRandomLine(provinceName);
        }

        public string GeneratePostalCode()
        {
            String postalCode = @"C:\Users\Mani Santhamohan\Documents\GitHub\A00429112_MCDA5510\ConsoleApp1\ConsoleApp1\postalcode.txt";
